...
class Tracker:
    ...
    def run_sequence2(self, seq, visualization=None, debug=None, visdom_info=None, multiobj_mode=None):
        """Run tracker on sequence.
        args:
            seq: Sequence to run the tracker on.
            visualization: Set visualization flag (None means default value specified in the parameters).
        ...
        output = self._track_sequence2(tracker, seq, init_info)
        return output

    def _track_sequence2(self, tracker, seq, init_info):
