...
class MDOTDataset(BaseDataset):
    ...
    def __init__(self):
        ...
        self.base_path = '/home/lab/share_ext4/wangjh/dataset/MDOT'
    ...
    # 该方法的目的是遍历指定的目录，收集每个子目录（代表不同的序列）中的图片文件信息，并将这些信息整理成一个列表返回
    def _get_sequence_info_list(self):
        # 创建两个空列表，用于存储序列的名称和路径。
        sequence_dir = []
        sequence_path = []
        for root, dirs, files in os.walk('/home/lab/share_ext4/wangjh/dataset/MDOT'):
            for dir in dirs:
                if dir == 'img':
