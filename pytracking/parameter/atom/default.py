...
def parameters():
    ...
    deep_feat = deep.ATOMResNet18(net_path='/home/jh/code/CRM-main/CRM-DiMP/pytracking/networks/atom_default.pth', output_layers=['layer3'], fparams=deep_fparams, normalize_power=2)
