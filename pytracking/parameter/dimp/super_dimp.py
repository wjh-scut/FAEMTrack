...
def parameters():
    ...
    params.net = NetWithBackbone(net_path='/home/lab/share/wangjh/vision_track/code/FAEMTrack/pytracking/networks/DiMPnet_ep0050.pth.tar',
