...
class Got10k(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None, seq_ids=None, data_fraction=None):
        ...
        args:
            ...
            data_fraction - Fraction of dataset to be used. The complete dataset is used by default 使用数据集的一部分。默认情况下使用完整的数据集
        """
        ...
        # self.sequence_meta_info = self._load_meta_info() #花费时间较长，可以考虑注释掉 2024.12.11
