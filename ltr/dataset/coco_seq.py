...
class MSCOCOSeq(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, data_fraction=None, split="train", version="2017"):  # pytracking 是 2014
        """
        args:
    ...
    def get_frames(self, seq_id=None, frame_ids=None, anno=None):
        ...
        # object_meta = self.get_meta_info(seq_id) 2024.12.11 影响运行速度
